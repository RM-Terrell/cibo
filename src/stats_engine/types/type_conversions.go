...
// ! two structs ever differ in any way. This is intentional.

// Converts a slice of annual earnings to a form ready for a Parquet file
func AnnualEarningsToParquet(records []AnnualEarningRecord) []AnnualEarningRecordParquet {
...
func CombinedPricesToParquet(records []CombinedPriceRecord) []CombinedPriceRecordParquet {
